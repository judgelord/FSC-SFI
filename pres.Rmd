...
# Governing through market power

(versus or along-side public policy)

---

Private Authority, Act 1: Objections to a mode of production 
...
Overall, we find ‘equilibrium’ policy scope: neither program significantly changed the scope of issues it addressed.
...
The industry-backed SFI program often contained language similar to that of the activist-backed FSC-US program (i.e., it was similar in scope), but often lacked (costlier) mandatory performance thresholds (i.e., the requirements were less prescriptive). This result suggests that any effort to test theories related to compliance cost or differentiation must distinguish between measures of stringency based on policy scope or prescriptiveness.
...
One pattern: requirements added by the activist-backed were more likely to impose costs on firms than requirements added by the industry-backed program, many of which may even benefit firms. 
