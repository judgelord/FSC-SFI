...
__Patterns of change in prescriptiveness among U.S. Forestry Certification Programs (FSC-US and SFI) on 48 Key Issues__
...
# Scope and Prescriptiveness of FSC and SFI 2008-2016
```{r FSC-SFI-data}
# Get data 
...
ggplot() +
aes(x = Year, y = Issue) + 
  facet_grid(. ~ Program)  + scale_fill_grey() + scale_color_grey() +
  geom_tile(aes(fill = Prescriptiveness)) + 
  geom_point(aes(shape = Change), color = "red", size = 5) +
  scale_shape_manual(values=c("-", "+", ""))+
  geom_segment(
    aes(xend = ifelse(Change == "No Change", Year+1, NA), yend = as.numeric(Issue)+1), color = "blue", size = .1)+ 
...
# Scope and Prescriptiveness of FSC and PEFC 2008-2015
