...
fsc <- d %>% 
  ...
  geom_col( aes(y = max), alpha = .2, width = .3, fill = "saddlebrown") +
    geom_line( aes(y = 10), color = "white")+
  geom_line( aes(y = 20), color = "white")+
    geom_line( aes(y = 30), color = "white")+
    geom_line( aes(y = 40), color = "white")+
    geom_line( aes(y = 50), color = "white")+
    geom_line( aes(y = 60), color = "white")+
    geom_line( aes(y = 70), color = "white")+
    geom_line( aes(y = 80), color = "white")+
    geom_line( aes(y = 90), color = "white")+
    geom_line( aes(y = 100), color = "white")+
    geom_line( aes(y = 110), color = "white")+
    geom_line( aes(y = 120), color = "white")+
...
### Policy Prescriptiveness (adapted from Cashore (1997))
